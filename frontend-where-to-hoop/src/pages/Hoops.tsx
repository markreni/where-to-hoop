    ...
    <div className="relative h-screen">
      ...
      <div>
        ...
        <div className="absolute bottom-2 left-[10px] z-1001">
          <MapLabel groups={[{ title: t('hoops.courtCondition'), selectedItems: selectedConditions, onToggleItems: toggleCondition, options: conditionOptions, clearFilter: clearConditionFilters, showInfoLink: true , infoLinkSectionId: 'condition-guidelines' }]} />
        </div>
      </div>
      )}
      { isMapView ? (
