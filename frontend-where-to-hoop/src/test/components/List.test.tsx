...
const mockHoops: { hoop: BasketballHoopWithEnrollments; distance: number }[] = [
  {
    hoop: {
      ...
      images: [{ id: 1, imagePath: 'https://example.com/court1.jpg', addedDate: '2024-01-15' }],
  ...
  },
  {
    hoop: {
      ...
      name: 'Indoor Gym',
      createdAt: '2024-01-15T10:00:00Z',
      images: [{ id: 2, imagePath: 'https://example.com/court2.jpg', addedDate: '2024-01-15' }],
      coordinates: { latitude: 60.1700, longitude: 24.9400 },
      description: { fi: '', en: 'Indoor basketball court' },
      condition: 'good',
      isIndoor: true,
      isPaid: false,
      addedBy: 'test@example.com',
