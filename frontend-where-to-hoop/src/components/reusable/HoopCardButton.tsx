...
const HoopCardButton = ({ actionFunction, title, bgColor }: HoopCardButtonProps) => {
  ...
  return (
    <Button 
      className={`${colorModeContext} flex items-center gap-2 padding-y-for-elements padding-x-for-elements border-1 border-black/20 shadow-md ${bgColor} text-white rounded-xl transition-colors text-fluid-sm whitespace-nowrap cursor-pointer dark:border-white/50`}
