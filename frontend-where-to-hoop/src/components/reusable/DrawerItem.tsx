...
export const DrawerItem = ({ to, icon, label, onClick }: DrawerItemProps) => {
  ...
  <Link
    to={to}
    onClick={onClick}
    className={`${colorModeContext} flex items-center gap-3 px-2 py-2 rounded-lg background-text-black transition-colors hover:bg-gray-100 dark:hover:bg-gray-800`}
  >
