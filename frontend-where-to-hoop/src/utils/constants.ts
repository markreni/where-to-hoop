...
// Arrival verification constants
const VERIFY_RANGE_METERS = 100;
const VERIFY_WINDOW_START_OFFSET_MS = 15 * 60 * 1000;
const VERIFY_WINDOW_END_OFFSET_MS = 30 * 60 * 1000;

export { minScreenSize, centerCoordinates, MAX_NAME_LENGTH, MAX_DESCRIPTION_LENGTH, MAX_IMAGE_SIZE_MB, MAX_IMAGE_SIZE_BYTES, MAX_PROFILE_IMAGE_SIZE_MB, MAX_PROFILE_IMAGE_SIZE_BYTES, MAX_IMAGES, helsinkiBounds, MAX_NOTE_LENGTH, MAX_BIO_LENGTH, emailDomain, VERIFY_RANGE_METERS, VERIFY_WINDOW_START_OFFSET_MS, VERIFY_WINDOW_END_OFFSET_MS };